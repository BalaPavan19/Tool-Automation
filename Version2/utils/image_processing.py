...
def approach2(image_np, width=6.33):
    ...
    statuses = {
        ...
        'width': {'status': False, 'message': ''},
        'length': {'status': False, 'message': ''}
    }
    ...
    for c in cnts:
        ...
        return Image.fromarray(cv2.cvtColor(orig, cv2.COLOR_BGR2RGB)), statuses
    
    return Image.fromarray(cv2.cvtColor(image_np, cv2.COLOR_BGR2RGB)), statuses
